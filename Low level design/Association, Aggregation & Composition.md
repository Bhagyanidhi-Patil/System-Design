...
✅ 1. Association (—) → “just uses”
    ✔ Signs:
        Used as function parameter / local variable
        Not stored as a member
        Temporary usage
    ...
    💻 Example:
        ...
        class Car {
        public:
            void start(Engine e) {   // 👈 just used
                // use engine
            }
        };

    Car does NOT own Engine ,It just uses it temporarily.

🔷 2. Aggregation (◇) → “has but doesn’t own”
    ✔ Signs:
        Stored as pointer or reference
    ...
    💻 Example:
        ...
        public:
            Car(Engine* e) {
                engine = e;   // external object
            }
        };

    Car has Engine ,But does NOT control its lifetime.

🔶 3. Composition (◆) → “owns strongly”
    ✔ Signs:
        Stored as object (not pointer)
        OR
        Created and destroyed inside class
    ...
    💻 Example 2 (Pointer but owned):
        ...
        public:
            ...
            ~Car() {
                delete engine;          // destroyed inside
            }
        };

    Car fully controls Engine.